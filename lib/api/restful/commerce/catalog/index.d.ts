 ...
 */
export default class Catalog extends Api {
    get basePath(): string;
    /**
     ...
     *     the response.
     */
    getChangeRequest(changeRequestId: string, marketplaceId: string, acceptLanguage: string): Promise<any>;
    /**
     * Note: The three catalog change request methods in the Catalog API are deprecated, and are scheduled to be
     * decommissioned in Q1 of 2020.
     *
     ...
     *     requests.
     */
    getChangeRequests(marketplaceId: string, acceptLanguage: string, { filter, limit, offset }?: {
        filter?: string;
        limit?: number;
        offset?: number;
    }): Promise<any>;
     ...
     */
    getProductMetadata(epid: string, { acceptLanguage, otherApplicableCategoryIds, primaryCategoryId, marketplaceId }?: {
     ...
     */
    getProductMetadataForCategories(primaryCategoryId: string, marketplaceId: string, { acceptLanguage, otherApplicableCategoryIds }?: {
        acceptLanguage?: string;
        otherApplicableCategoryIds?: string;
    }): Promise<any>;
}
