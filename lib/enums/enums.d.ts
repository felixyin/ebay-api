...
export declare enum ShippingCarrierEnum {
...
export declare enum EscalateReasonEnum {
...
export declare enum DecisionEnum {
...
export declare enum ReturnCountFilterEnum {
    ALL_OPEN = "ALL_OPEN",
...
export declare enum ReturnStateEnum {
...
export declare enum RefundFeeTypeEnum {
...
export declare enum ActivityOptionEnum {
